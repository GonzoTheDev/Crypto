...
posted to #cryptocoin-dev on irc.freenode.net).
...
Copyright (c) 2021-2030 Cryptocoin Foundation.
...
The "Cryptocoin Maintainer Team" is defined in this document as the following users:
- Gonzo
- Sorch
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Cryptocoin code or Cryptocoin's dependency code or Cryptocoin's potential/future dependency code or research which successfully implements Cryptocoin.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Cryptocoin Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Cryptocoin Maintainer Team.
